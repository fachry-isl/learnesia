  ...
  const [course, setCourse] = useState({
    ...
    lessons: [
      ...
      },
      {
        ...
        lessons_content: "Neural networks are inspired by the human brain...",
      },
    ],
  });
  ...
  return (
    <div className="w-full">
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <textarea
                  value={lesson.lessons_content}
                  onChange={(e) =>
                    handleLessonChange(index, "lessons_content", e.target.value)
                  }
                  className="border-2 border-black w-full text-black p-2 resize-none"
                  rows={3}
                ></textarea>
      ...
      <div className="flex gap-3">
        <button className="border-2 border-black bg-black text-white cursor-pointer px-5 py-2 font-semibold hover:bg-gray-800">
          Submit Course
        </button>
