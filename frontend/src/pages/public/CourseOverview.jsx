  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="border-b border-gray-100 py-4 bg-gray-50/50">
        <div className="max-w-7xl mx-auto px-6 flex items-center gap-2 text-xs font-bold font-space uppercase tracking-wider text-gray-400">
          <span
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-8">
              <div className="space-y-1">
                <p className="text-[10px] font-black font-space uppercase tracking-[0.2em] text-gray-400 mb-4">
                  Contents
                </p>
                {navItems.map((item) => (
                  <button
                    key={item.id}
                    className={`w-full text-left px-4 py-3 text-sm font-bold font-space border-l-4 transition-all ${
          ...
          <div className="lg:col-span-3 space-y-24 pb-32">
            ...
            >
              <h2 className="text-3xl font-black font-jakarta text-gray-900 tracking-tight mb-6">
                {course.course_name}
              </h2>
            ...
            >
              <div className="flex items-center justify-between">
                <h2 className="text-4xl font-black font-jakarta text-gray-900 tracking-tight underline decoration-black-500/30 underline-offset-8">
                  Syllabus
                </h2>
