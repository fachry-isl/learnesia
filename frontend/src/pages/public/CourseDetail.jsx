          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-8">
                  ...
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 text-sm font-bold border-l-4 transition-all ${
                      activeSection === item.id
                        ? "border-pink-500 text-gray-900 bg-pink-50/50"
              ...
              <div className="pt-6">
                <button
                  onClick={() =>
                    navigate(`/course/learning/${course.course_slug}`)
                  }
                  className="w-full py-4 bg-pink-600 text-white font-black rounded-lg shadow-lg shadow-pink-200 hover:bg-pink-700 hover:-translate-y-0.5 transition-all active:translate-y-0 uppercase text-sm tracking-widest"
                >
                  Go to Dashboard
                </button>
              </div>
          ...
          <div className="lg:col-span-3 space-y-24 pb-32">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {skills.map((skill, i) => (
                    <span
                      key={i}
                      className="px-4 py-1.5 bg-gray-50 border border-gray-200 rounded-full text-xs font-bold text-gray-600 hover:border-pink-300 hover:text-pink-600 transition-colors cursor-default"
                    >
                      {skill}
                    </span>
                  ))}
            ...
            >
              <div className="flex items-center justify-between">
                <h2 className="text-4xl font-black text-gray-900 tracking-tight underline decoration-pink-500/30 underline-offset-8">
                  Syllabus
                </h2>
                <button className="px-6 py-2.5 border-2 border-pink-500 text-pink-500 font-black rounded-full hover:bg-pink-50 transition-all uppercase text-xs tracking-widest">
                  Download syllabus
                </button>
              </div>
                      ...
                      {isExpanded && (
                        <div className="p-6 pt-0 space-y-6 bg-white border-t border-gray-100 animate-in slide-in-from-top-2 duration-300">
                          <div className="pt-6 space-y-4">
                            <p className="text-sm text-gray-500 font-medium italic border-l-2 border-pink-200 pl-4 py-1">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              {lesson.lesson_learning_objectives
                                ...
                                .map((obj, i) => (
                                  ...
                                  >
                                    <div className="w-5 h-5 bg-pink-100 text-pink-600 flex items-center justify-center rounded-full shrink-0 text-[10px]">
                                      {i + 1}
                                    </div>
                                    {obj}
                                  </div>
            ...
            >
              <div className="absolute top-0 right-0 w-64 h-64 bg-pink-500/20 blur-[100px] -z-0"></div>
              <div className="relative z-10 space-y-6 max-w-lg">
                <span className="inline-block px-3 py-1 bg-pink-600 font-black text-[10px] uppercase tracking-widest rounded">
            ...
            >
              ...
              <div className="flex flex-col md:flex-row gap-8 items-start">
                ...
                <div className="space-y-4 flex-1">
                  <h3 className="text-2xl font-black italic hover:text-pink-600 transition-colors cursor-pointer">
                    LearnEsia Protocol
                  </h3>
                  ...
                  <button className="text-pink-600 font-black text-sm uppercase tracking-widest border-b-2 border-pink-600 hover:text-pink-700 hover:border-pink-700 transition-all">
                    View Full Profile
                  </button>
                </div>
              </div>
